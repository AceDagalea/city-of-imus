    ...
    >
      <div className="mx-auto grid max-w-7xl gap-10 px-4 md:grid-cols-2 md:gap-14 md:px-6">
        <div className="flex gap-5">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border-2 border-imus-green/30 bg-imus-green/10 text-imus-greenDark">
            <Binoculars className="h-7 w-7" aria-hidden="true" />
          </div>
          <div>
            <h2 id="about-vm-heading" className="font-heading text-xl font-bold text-imus-navy md:text-2xl">

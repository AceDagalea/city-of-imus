...
export default function DigitalFeaturesBar() {
  return (
    <section className="bg-tenant-sky py-12 md:py-14" aria-label="Platform features">
          ...
          {FEATURES.map((feature) => {
            ...
            return (
              <div key={feature.title} className="text-center sm:text-left">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border-2 border-tenant-navy sm:mx-0">
                  <Icon className="h-5 w-5 text-tenant-navy" aria-hidden="true" />
                </div>
                <h3 className="font-heading font-bold text-tenant-navy">{feature.title}</h3>

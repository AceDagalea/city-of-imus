  ...
  return (
    <section className="mt-12 md:mt-16" aria-labelledby="mayor-agenda-heading">
      <div className="text-center">
        ...
        <div className="mx-auto mt-3 h-1 w-14 rounded-full bg-tenant-green" aria-hidden="true" />
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {MAYOR_AGENDA_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-tenant-green/10 text-tenant-greenDark">
                <Icon className="h-7 w-7" aria-hidden="true" />
              </div>
              <h3 className="mt-4 font-heading text-sm font-bold leading-snug text-tenant-navy">
